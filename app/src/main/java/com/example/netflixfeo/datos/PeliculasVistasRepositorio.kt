...
class ConexionPeliculasVistasRepositorio(
    ...
    override suspend fun obtenerPeliculaVista(id: String): Int =
    ...
    override suspend fun insertar(peliculaVista: PeliculaVista) =
        peliculasVistasDao.insertar(peliculaVista)

    override suspend fun actualizar(peliculaVista: PeliculaVista) =
        peliculasVistasDao.actualizar(peliculaVista)

    override suspend fun eliminar(peliculaVista: PeliculaVista) =
        peliculasVistasDao.eliminar(peliculaVista)
}